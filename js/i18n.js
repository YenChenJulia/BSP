...
const locales = {
  ...
  en: {
    ...
    RightProduct: {
      ...
      A1: "It's an unsecured loan offered through the Easy App by Bank SinoPac, following the bank's policies and State Bank of Viet Nam regulations.",
      Q2: "2. What documents do I need for the loan application?",
      A2: "Valid Chip - based citizen ID card, financial documents (Labor contract, Bank Statement, VSSID…)",
      ...
      A5: "Make equal monthly loan payments, with interest calculated on the declining balance. Ensure sufficient funds in your payment account before the monthly due date to avoid incurring overdue interest.",
      Q6: "6. What is the maximum loan duration?",
      A6: "You can select a loan tenor of up to 60 months.",
      Q7: "7. What happens if I miss a payment?",
      A7: "Late payments will incur overdue interest. Additionally, late payments will be reported to the Credit Information Center (CIC) as per the regulations of the State Bank of Vietnam.",
      Q8: "8. How will the bank remind me to make repayments?",
      A8: "Please ensure that your SinoPac account has sufficient funds before the payment due date. If you are making a payment via transfer from another bank, please do so before 4 PM from Monday to Friday to ensure the loan is paid on time.",
  ...
  vi: {
    ...
    RightProduct: {
      ...
      A2: "Thẻ căn cước công dân có gắn chip hợp lệ, các giấy tờ tài chính (Hợp đồng lao động, Sao kê ngân hàng, VSSID…)",
      ...
      A5: "Thanh toán số tiền vay bằng nhau hàng tháng, lãi suất được tính theo dự nợ giảm dần. Đảm bảo số dư trong tài khoản thanh toán của Quý khách hàng trước ngày thanh toán hàng tháng, để tránh phát sinh lãi quá hạn.",
      Q6: "6. Thời hạn vay tối đa là bao nhiêu?",
      A6: "Quý khách hàng có thể lựa chọn thời hạn vay vốn lên đến 60 tháng.",
      Q7: "7. Nếu tôi bị trễ khoản thanh toán, tôi sẽ phải xử lý  như thế nào?",
      A7: "Các khoản chậm thanh toán sẽ phát sinh lãi quá hạn. Ngoài ra, các khoản thanh toán chậm sẽ được báo cáo cho Trung Tâm Thông Tin Tín Dụng (CIC) theo quy định của Ngân Hàng Nhà Nước Việt Nam.",
      Q8: "8. Ngân hàng có gửi thông báo đến khách hàng khi đến hạn thanh toán không?",
      A8: "Vui lòng đảm bảo tài khoản SinoPac của Quý Khách hàng có đủ số dư trước ngày thanh toán. Nếu Quý Khách hàng thanh toán bằng việc chuyển khoản từ ngân hàng khác, vui lòng thực hiện trước 16g từ thứ 2 – thứ 6 để đảm bảo khoản vay được thanh toán đúng hạn.",
